...
class notification extends React.Component{
    ...
    load_feed = () =>{
        ...
        let that = this;
        f.database().ref('photos').orderByChild('posted').once('value').then(function(snapshot){
        ...
        <View style = {{flex:1}}>
            ...
            <View key={index} style={{width:'100%', overflow:'hidden', marginBottom:5 ,justifyContent:'space-between' ,borderBottomWidth:1, borderColor:'grey'}}>
               ...
               <View style={{height:50, width:'100%', borderColor:"rgb(233,233,233)", flexDirection:"row" }}>
                   <Image source={require('../images/icons-share.png')} style={{height:40, width:40}} />
